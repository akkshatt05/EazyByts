...
function Home() {
  ...
  }, [profile, skills, projects, achievements, posts]);
    ...
    >
      ...
      >
        <div className="hero-content">
          <div className="availability-badge reveal-on-scroll">
            <span className="availability-dot"></span>
            Available for Opportunities
          </div>

          <p className="hero-small-text reveal-on-scroll reveal-delay-1">
            Hey, I'm
          </p>
          ...
          <h2 className="reveal-on-scroll reveal-delay-2">
            {profile?.profileRole ||
              "Full Stack Developer"}
          </h2>

          <p className="hero-description reveal-on-scroll reveal-delay-2">
            {profile?.about ||
              "I'm an AI & Data Science student who enjoys building practical web projects and learning full-stack development."}
          </p>

          <div className="hero-buttons reveal-on-scroll reveal-delay-3">
            <a
              href="#projects"
          ...
          <div className="hero-stats reveal-on-scroll reveal-delay-3">
            <div className="hero-stat">
              <strong>{animatedProjects}+</strong>
              <span>Projects</span>
            </div>

            <div className="hero-stat">
              <strong>{animatedSkills}+</strong>
              <span>Skills</span>
            </div>

            <div className="hero-stat">
              <strong>{animatedAchievements}+</strong>
      ...
      >
        ...
        <div className="about-card reveal-on-scroll reveal-delay-1">
          ...
          <div className="about-card-right">
            <p>
              {profile?.about ||
                "I'm an AI & Data Science student who likes turning ideas into working projects. I enjoy exploring web development, learning new technologies and improving my skills by building things myself."}
            </p>
      ...
      >
        <div className="skills-section-heading reveal-on-scroll">
          <span className="section-label">
            WHAT I WORK WITH
          </span>
          ...
          <p>
            A few of the languages, tools and
                ...
                >
                  ...
                  <div className="skill-progress-wrapper">
                    <div className="skill-progress-track">
                      <div className="skill-progress-fill reveal-progress"></div>
                    </div>
                  </div>
      ...
      >
        <div className="projects-section-heading reveal-on-scroll">
          <span className="section-label">
            THINGS I'VE BUILT
          </span>
          ...
          <p>
            A few projects I've worked on while
            learning and building with different
            technologies.
          </p>
        </div>
              ...
              >
                ...
                <div className="portfolio-project-content professional-project-content">
                  ...
                  <p className="project-description">
                    {project.description ||
                      "A project I built while exploring new tools and technologies."}
                  </p>
      ...
      >
        <div className="achievements-section-heading reveal-on-scroll">
          <span className="section-label">
            MILESTONES
          </span>
          ...
          <p>
            Courses, certifications and milestones
      ...
      >
        <div className="blog-section-heading reveal-on-scroll">
          <span className="section-label">
            NOTES & ARTICLES
          </span>
          ...
          <p>
            I'll use this space to share things
            I'm learning, building and figuring out.
          </p>
        </div>
      ...
      >
        <div className="contact-section-heading reveal-on-scroll">
          <span className="section-label">
            GET IN TOUCH
          </span>
        ...
        <div className="professional-contact-card reveal-on-scroll reveal-delay-1">
          <div className="contact-card-content">
            ...
            <p>
              Feel free to reach out about a
